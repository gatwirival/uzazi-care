 ...
 * 
 * Uses the configured AI provider with specialized prompts for different report types
 */

import { sendChatCompletion, type ChatMessage } from '@/lib/ai/ai-client';
...
export async function generateMedicalReport(
  ...
  // Generate report using the configured AI provider
...
export async function streamMedicalReport(
  ...
  // This would use streamChatCompletion from the shared AI client
